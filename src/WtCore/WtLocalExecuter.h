...
public:
	...
	OrderIDs	buy(const char* code, double price, double qty, bool bForceClose) override;
	OrderIDs	sell(const char* code, double price, double qty, bool bForceClose) override;
