...
void WtSimpleRiskMon::init(WtPortfolioContext* ctx, WTSVariant* cfg)
{
	...
	ctx->writeRiskLog(fmt::format("Params inited, Checking frequency: {} s, MaxIDD: {}({:.2f}%), MaxMDD: {}({:.2f}%), Capital: {:.1f}, Profit Boundary: {:.2f}%, Calc Span: {} mins, Risk Scale: {:.2f}",
